...
| First introduced | Chip | Description | Design |
|---:|---|---|---|
| 1970 | 74181 / SN74LS181 | 4-bit TTL arithmetic logic unit and function generator | [alu_74181](alu_74181/) |
| 1971 | Intel 4004 | 4-bit microprocessor, the first commercial single-chip CPU (MCS-4) | [intel_4004](intel_4004/) |
...
| 1976 | Intel 8279 | Programmable keyboard and display interface | [intel_8279](intel_8279/) |
...
The Intel 8279 entry records **1976**, the year Intel introduced the programmable keyboard/display interface for MCS-80 and MCS-85 microcomputer systems, per the [Intel 8279 historical overview](https://en.wikipedia.org/wiki/Intel_8279) and contemporary MCS-85 peripheral documentation. The exact launch month is unrecorded in surviving catalogs, so the index retains the year. Technical behavior is sourced from the [Intel 8279 datasheet](https://archive.org/details/bitsavers_inteldataBCatalog_75793335) and system schematics, summarized in the design's [specification](intel_8279/spec/spec.md).
