...
read_verilog -sv $DESIGN_DIR/src/intel_4004.sv
hierarchy -check -top intel_4004
proc
flatten
opt -full
fsm
...
check
stat
write_verilog -noattr $WORK_DIR/intel_4004_synth.v
write_json $WORK_DIR/intel_4004_synth.json
EOF
