...
read_verilog -sv $DESIGN_DIR/src/intel_8255.sv
hierarchy -check -top intel_8255
proc
flatten
opt -full
fsm
...
check
stat
write_verilog -noattr $WORK_DIR/intel_8255_synth.v
write_json $WORK_DIR/intel_8255_synth.json
EOF
